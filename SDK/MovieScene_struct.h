...
struct FMovieSceneEvalTemplate : FMovieSceneEvalTemplateBase {
	...
	struct FWeakObjectPtr<struct UMovieSceneSection> SourceSectionPtr; // 0x18(0x08)
};
...
struct FMovieSceneSectionGroup {
	struct TArray<struct FWeakObjectPtr<struct UMovieSceneSection>> Sections; // 0x00(0x10)
};
...
struct FMovieSceneBindingOverrideData {
	...
	struct FWeakObjectPtr<struct UObject> Object; // 0x18(0x08)
	char UnknownData_20_0 : 7; // 0x20(0x01)
	bool bOverridesDefault : 1; // 0x20(0x01)
...
// ScriptStruct MovieScene.MovieSceneEasing
// Size: 0x10 (Inherited: 0x00)
struct FMovieSceneEasing {
	struct UCurveFloat* Curve; // 0x00(0x08)
	enum class EMovieSceneBuiltInEasing Type; // 0x08(0x01)
	char UnknownData_9_0 : 7; // 0x09(0x01)
	bool bUseCustomCurve : 1; // 0x09(0x01)
...
struct FMovieSceneOrderedEvaluationKey {
	...
	uint16 SetupIndex; // 0x0c(0x02)
	uint16 TearDownIndex; // 0x0e(0x02)
};
...
struct FMovieSceneSubSectionData {
	struct FWeakObjectPtr<struct UMovieSceneSubSection> Section; // 0x00(0x08)
...
struct FMovieSceneRootEvaluationTemplateInstance {
	...
	char UnknownData_68[0x2b8]; // 0x68(0x2b8)
};
...
struct FMovieSceneFloatChannel : FMovieSceneChannel {
	...
	bool bHasDefaultValue : 1; // 0x34(0x01)
...
struct FMovieSceneFloatValue {
	...
	enum class None PaddingByte; // 0x1a(0x01)
...
struct FMovieSceneIntegerChannel : FMovieSceneChannel {
	...
	bool bHasDefaultValue : 1; // 0x1c(0x01)
...
struct FMovieSceneObjectPathChannel : FMovieSceneChannel {
	...
	char UnknownData_60[0x60]; // 0x60(0x60)
};
...
struct FMovieSceneEasingSettings {
	...
	struct FMovieSceneEasing NewEaseIn; // 0x08(0x10)
	char UnknownData_18_0 : 7; // 0x18(0x01)
	bool bManualEaseIn : 1; // 0x18(0x01)
	char UnknownData_19[0x3]; // 0x19(0x03)
	int32_t ManualEaseInDuration; // 0x1c(0x04)
	struct FMovieSceneEasing NewEaseOut; // 0x20(0x10)
	char UnknownData_30_0 : 7; // 0x30(0x01)
	bool bManualEaseOut : 1; // 0x30(0x01)
...
struct FMovieSceneSectionEvalOptions {
	char UnknownData_0_0 : 7; // 0x00(0x01)
	bool bCanEditCompletionMode : 1; // 0x00(0x01)
...
struct FMovieSceneSpawnable {
	...
	bool bContinuouslyRespawn : 1; // 0x40(0x01)
