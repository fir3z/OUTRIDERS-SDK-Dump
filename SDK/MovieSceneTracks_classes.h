...
struct UMovieSceneTransformOrigin : UInterface {
	...
	struct FTransform BP_GetTransformOrigin(); // Function MovieSceneTracks.MovieSceneTransformOrigin.BP_GetTransformOrigin // (Event|Protected|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x1a35c70
};
...
struct UMovieScene3DConstraintSection : UMovieSceneSection {
	...
	void SetConstraintBindingID(struct FMovieSceneObjectBindingID InConstraintBindingID); // Function MovieSceneTracks.MovieScene3DConstraintSection.SetConstraintBindingID // (Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure) // @ game+0x283d580
	struct FMovieSceneObjectBindingID GetConstraintBindingID(); // Function MovieSceneTracks.MovieScene3DConstraintSection.GetConstraintBindingID // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x283d520
};
...
struct UMovieScene3DPathSection : UMovieScene3DConstraintSection {
	...
	char UnknownData_1AC_3 : 5; // 0x1ac(0x01)
...
struct UMovieScene3DTransformSection : UMovieSceneSection {
	...
	char UnknownData_728[0x4]; // 0x728(0x04)
	char UnknownData_72C_0 : 7; // 0x72c(0x01)
	bool bUseQuaternionInterpolation : 1; // 0x72c(0x01)
...
struct UMovieSceneAudioSection : UMovieSceneSection {
	...
	struct TSoftObjectPtr<struct USoundBase> SoundPtr; // 0xe8(0x28)
	struct FFrameNumber StartFrameOffset; // 0x110(0x04)
	float StartOffset; // 0x114(0x04)
	float AudioStartTime; // 0x118(0x04)
	float AudioDilationFactor; // 0x11c(0x04)
	float AudioVolume; // 0x120(0x04)
	char UnknownData_124[0x4]; // 0x124(0x04)
	struct FMovieSceneFloatChannel SoundVolume; // 0x128(0xa0)
	struct FMovieSceneFloatChannel PitchMultiplier; // 0x1c8(0xa0)
	struct FMovieSceneActorReferenceData AttachActorData; // 0x268(0xb0)
	char UnknownData_318_0 : 7; // 0x318(0x01)
	bool bSuppressSubtitles : 1; // 0x318(0x01)
	char UnknownData_319_0 : 7; // 0x319(0x01)
	bool bOverrideAttenuation : 1; // 0x319(0x01)
	char UnknownData_31A[0x6]; // 0x31a(0x06)
	struct USoundAttenuation* AttenuationSettings; // 0x320(0x08)
	struct FDelegate OnQueueSubtitles; // 0x328(0x10)
	struct FMulticastInlineDelegate OnAudioFinished; // 0x338(0x10)
	struct FMulticastInlineDelegate OnAudioPlaybackPercent; // 0x348(0x10)
	float SyncAudioDeltaTime; // 0x358(0x04)
	char UnknownData_35C_0 : 7; // 0x35c(0x01)
	bool bOneShot : 1; // 0x35c(0x01)
	char UnknownData_35D[0x3]; // 0x35d(0x03)

	void SetStartOffset(struct FFrameNumber InStartOffset); // Function MovieSceneTracks.MovieSceneAudioSection.SetStartOffset // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x283d640
	struct FFrameNumber GetStartOffset(); // Function MovieSceneTracks.MovieSceneAudioSection.GetStartOffset // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x283d560
};
...
struct UMovieSceneCameraCutSection : UMovieSceneSection {
	...
	void SetCameraBindingID(struct FMovieSceneObjectBindingID InCameraBindingID); // Function MovieSceneTracks.MovieSceneCameraCutSection.SetCameraBindingID // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x283d580
	struct FMovieSceneObjectBindingID GetCameraBindingID(); // Function MovieSceneTracks.MovieSceneCameraCutSection.GetCameraBindingID // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x283d520
};
...
struct UMovieSceneCinematicShotSection : UMovieSceneSubSection {
	...
	void SetShotDisplayName(struct FString InShotDisplayName); // Function MovieSceneTracks.MovieSceneCinematicShotSection.SetShotDisplayName // (Final|Native|Public|BlueprintCallable) // @ game+0x2843e80
	struct FString GetShotDisplayName(); // Function MovieSceneTracks.MovieSceneCinematicShotSection.GetShotDisplayName // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2843ce0
};
...
struct UMovieSceneColorTrack : UMovieScenePropertyTrack {
	...
	bool bIsSlateColor : 1; // 0x88(0x01)
...
struct UMovieSceneLevelVisibilitySection : UMovieSceneSection {
	...
	void SetVisibility(enum class ELevelVisibility InVisibility); // Function MovieSceneTracks.MovieSceneLevelVisibilitySection.SetVisibility // (Final|Native|Public|BlueprintCallable) // @ game+0x2843f70
	void SetLevelNames(struct TArray<struct FName> InLevelNames); // Function MovieSceneTracks.MovieSceneLevelVisibilitySection.SetLevelNames // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x2843dd0
	enum class ELevelVisibility GetVisibility(); // Function MovieSceneTracks.MovieSceneLevelVisibilitySection.GetVisibility // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2843da0
	struct TArray<struct FName> GetLevelNames(); // Function MovieSceneTracks.MovieSceneLevelVisibilitySection.GetLevelNames // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2843cb0
};
...
struct UMovieSceneSkeletalAnimationSection : UMovieSceneSection {
	struct FMovieSceneSkeletalAnimationParams Params; // 0xe0(0x100)
	struct UAnimSequence* AnimSequence; // 0x1e0(0x08)
	struct UAnimSequenceBase* Animation; // 0x1e8(0x08)
	float StartOffset; // 0x1f0(0x04)
	float EndOffset; // 0x1f4(0x04)
	float PlayRate; // 0x1f8(0x04)
	char bReverse : 1; // 0x1fc(0x01)
	char UnknownData_1FC_1 : 7; // 0x1fc(0x01)
	char UnknownData_1FD[0x3]; // 0x1fd(0x03)
	struct FName SlotName; // 0x200(0x08)
	char bDynamic : 1; // 0x208(0x01)
	char UnknownData_208_1 : 7; // 0x208(0x01)
	char UnknownData_209[0x7]; // 0x209(0x07)
	struct TSoftObjectPtr<struct UAnimSequenceBase> SecondaryAnimation; // 0x210(0x28)
	char bUseSecondaryAnim : 1; // 0x238(0x01)
...
struct UMovieSceneSkeletalAnimationTrack : UMovieSceneNameableTrack {
	...
	bool bUseLegacySectionIndexBlend : 1; // 0x68(0x01)
