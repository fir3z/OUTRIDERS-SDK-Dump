...
struct FGeomComponentCacheParameters {
	...
	bool SaveTrailingData : 1; // 0x3c(0x01)
	char UnknownData_3D_0 : 7; // 0x3d(0x01)
	bool DoGenerateTrailingData : 1; // 0x3d(0x01)
