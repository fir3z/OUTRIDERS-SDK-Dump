...
struct UAxisAngleGizmo : UInteractiveGizmo {
	...
	bool bInInteraction : 1; // 0x88(0x01)
...
struct UAxisPositionGizmo : UInteractiveGizmo {
	...
	struct TScriptInterface<None> StateTarget; // 0x78(0x10)
	char UnknownData_88_0 : 7; // 0x88(0x01)
	bool bEnableSignedAxis : 1; // 0x88(0x01)
	char UnknownData_89_0 : 7; // 0x89(0x01)
	bool bInInteraction : 1; // 0x89(0x01)
...
struct UInteractiveToolPropertySet : UObject {
	...
	bool bIsPropertySetEnabled : 1; // 0x48(0x01)
...
struct UBrushBaseProperties : UInteractiveToolPropertySet {
	...
	bool bSpecifyRadius : 1; // 0x54(0x01)
	...
	bool bShowStrength : 1; // 0x64(0x01)
	char UnknownData_65_0 : 7; // 0x65(0x01)
	bool bShowFalloff : 1; // 0x65(0x01)
...
struct UBaseBrushTool : UMeshSurfacePointTool {
	...
	bool bInBrushStroke : 1; // 0xc8(0x01)
	char UnknownData_C9[0x7]; // 0xc9(0x07)
	struct FBrushStampData LastBrushStamp; // 0xd0(0xb8)
	char UnknownData_188[0x10]; // 0x188(0x10)
	SoftClassProperty PropertyClass; // 0x198(0x28)
	struct UBrushStampIndicator* BrushStampIndicator; // 0x1c0(0x08)
};
...
struct UBrushStampIndicator : UInteractiveGizmo {
	...
	bool bDrawIndicatorLines : 1; // 0x58(0x01)
	char UnknownData_59_0 : 7; // 0x59(0x01)
	bool bDrawRadiusCircle : 1; // 0x59(0x01)
	char UnknownData_5A_0 : 7; // 0x5a(0x01)
	bool bDrawFalloffCircle : 1; // 0x5a(0x01)
	...
	bool bDepthTested : 1; // 0x74(0x01)
	char UnknownData_75_0 : 7; // 0x75(0x01)
	bool bDrawSecondaryLines : 1; // 0x75(0x01)
...
struct UClickDragInputBehavior : UAnyButtonInputBehavior {
	...
	bool bUpdateModifiersDuringDrag : 1; // 0x120(0x01)
...
struct UGizmoBaseComponent : UPrimitiveComponent {
	...
	float HoverSizeMultiplier; // 0x4e0(0x04)
	float PixelHitDistanceThreshold; // 0x4e4(0x04)
	char UnknownData_4E8[0x8]; // 0x4e8(0x08)

	void UpdateWorldLocalState(bool bWorldIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState // (Final|Native|Public) // @ game+0x39954f0
	void UpdateHoverState(bool bHoveringIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState // (Final|Native|Public) // @ game+0x3995460
};

// Class InteractiveToolsFramework.GizmoArrowComponent
// Size: 0x510 (Inherited: 0x4f0)
struct UGizmoArrowComponent : UGizmoBaseComponent {
	struct FVector Direction; // 0x4f0(0x0c)
	float Gap; // 0x4fc(0x04)
	float Length; // 0x500(0x04)
	float Thickness; // 0x504(0x04)
...
struct UGizmoBoxComponent : UGizmoBaseComponent {
	struct FVector Origin; // 0x4f0(0x0c)
	char UnknownData_4FC[0x4]; // 0x4fc(0x04)
	struct FQuat Rotation; // 0x500(0x10)
	struct FVector Dimensions; // 0x510(0x0c)
	float LineThickness; // 0x51c(0x04)
	char UnknownData_520_0 : 7; // 0x520(0x01)
	bool bRemoveHiddenLines : 1; // 0x520(0x01)
	char UnknownData_521_0 : 7; // 0x521(0x01)
	bool bEnableAxisFlip : 1; // 0x521(0x01)
	char UnknownData_522[0xe]; // 0x522(0x0e)
};

// Class InteractiveToolsFramework.GizmoCircleComponent
// Size: 0x510 (Inherited: 0x4f0)
struct UGizmoCircleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x4f0(0x0c)
	float Radius; // 0x4fc(0x04)
	float Thickness; // 0x500(0x04)
	int32_t NumSides; // 0x504(0x04)
	char UnknownData_508_0 : 7; // 0x508(0x01)
	bool bViewAligned : 1; // 0x508(0x01)
	char UnknownData_509_0 : 7; // 0x509(0x01)
	bool bOnlyAllowFrontFacingHits : 1; // 0x509(0x01)
...
struct UGizmoTransformSource : UInterface {
	...
	void SetTransform(struct FTransform NewTransform); // Function InteractiveToolsFramework.GizmoTransformSource.SetTransform // (Native|Public|HasOutParms|HasDefaults) // @ game+0x39952f0
	struct FTransform GetTransform(); // Function InteractiveToolsFramework.GizmoTransformSource.GetTransform // (Native|Public|HasDefaults|Const) // @ game+0x39951f0
};
...
struct UGizmoAxisSource : UInterface {
	...
	bool HasTangentVectors(); // Function InteractiveToolsFramework.GizmoAxisSource.HasTangentVectors // (Native|Public|Const) // @ game+0x39399b0
	void GetTangentVectors(struct FVector TangentXOut, struct FVector TangentYOut); // Function InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors // (Native|Public|HasOutParms|HasDefaults|Const) // @ game+0x3995100
	struct FVector GetOrigin(); // Function InteractiveToolsFramework.GizmoAxisSource.GetOrigin // (Native|Public|HasDefaults|Const) // @ game+0x3995050
	struct FVector GetDirection(); // Function InteractiveToolsFramework.GizmoAxisSource.GetDirection // (Native|Public|HasDefaults|Const) // @ game+0x3995010
};
...
struct UGizmoClickTarget : UInterface {
	...
	void UpdateHoverState(bool bHovering); // Function InteractiveToolsFramework.GizmoClickTarget.UpdateHoverState // (Native|Public|Const) // @ game+0x39953d0
};
...
struct UGizmoStateTarget : UInterface {
	...
	void EndUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.EndUpdate // (Native|Public) // @ game+0x3948cc0
	void BeginUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.BeginUpdate // (Native|Public) // @ game+0x3948ca0
};
...
struct UGizmoFloatParameterSource : UInterface {
	...
	void SetParameter(float NewValue); // Function InteractiveToolsFramework.GizmoFloatParameterSource.SetParameter // (Native|Public) // @ game+0x3929430
	float GetParameter(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.GetParameter // (Native|Public|Const) // @ game+0x3995090
	void EndModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.EndModify // (Native|Public) // @ game+0x3994ff0
	void BeginModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.BeginModify // (Native|Public) // @ game+0x3948cc0
};
...
struct UGizmoVec2ParameterSource : UInterface {
	...
	void SetParameter(struct FVector2D NewValue); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.SetParameter // (Native|Public|HasOutParms|HasDefaults) // @ game+0x3995260
	struct FVector2D GetParameter(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter // (Native|Public|HasDefaults|Const) // @ game+0x39950c0
	void EndModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.EndModify // (Native|Public) // @ game+0x3994ff0
	void BeginModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.BeginModify // (Native|Public) // @ game+0x3948cc0
};
...
struct UGizmoLineHandleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x4f0(0x0c)
	float HandleSize; // 0x4fc(0x04)
	float Thickness; // 0x500(0x04)
	struct FVector Direction; // 0x504(0x0c)
	float Length; // 0x510(0x04)
	char UnknownData_514_0 : 7; // 0x514(0x01)
	bool bImageScale : 1; // 0x514(0x01)
	char UnknownData_515[0xb]; // 0x515(0x0b)
};

// Class InteractiveToolsFramework.GizmoRectangleComponent
// Size: 0x520 (Inherited: 0x4f0)
struct UGizmoRectangleComponent : UGizmoBaseComponent {
	struct FVector DirectionX; // 0x4f0(0x0c)
	struct FVector DirectionY; // 0x4fc(0x0c)
	float OffsetX; // 0x508(0x04)
	float OffsetY; // 0x50c(0x04)
	float LengthX; // 0x510(0x04)
	float LengthY; // 0x514(0x04)
	float Thickness; // 0x518(0x04)
	enum class None SegmentFlags; // 0x51c(0x01)
...
struct UInputRouter : UObject {
	...
	bool bAutoInvalidateOnHover : 1; // 0x28(0x01)
	char UnknownData_29_0 : 7; // 0x29(0x01)
	bool bAutoInvalidateOnCapture : 1; // 0x29(0x01)
...
struct AIntervalGizmoActor : AGizmoActor {
	struct UGizmoLineHandleComponent* UpIntervalComponent; // 0x2f0(0x08)
	struct UGizmoLineHandleComponent* DownIntervalComponent; // 0x2f8(0x08)
	struct UGizmoLineHandleComponent* ForwardIntervalComponent; // 0x300(0x08)
};
...
struct UPlanePositionGizmo : UInteractiveGizmo {
	...
	bool bEnableSignedAxis : 1; // 0x88(0x01)
	char UnknownData_89_0 : 7; // 0x89(0x01)
	bool bFlipX : 1; // 0x89(0x01)
	char UnknownData_8A_0 : 7; // 0x8a(0x01)
	bool bFlipY : 1; // 0x8a(0x01)
	char UnknownData_8B_0 : 7; // 0x8b(0x01)
	bool bInInteraction : 1; // 0x8b(0x01)
	struct FVector InteractionOrigin; // 0x8c(0x0c)
...
struct USingleClickInputBehavior : UAnyButtonInputBehavior {
	...
	bool HitTestOnRelease : 1; // 0xc0(0x01)
...
struct ATransformGizmoActor : AGizmoActor {
	struct UPrimitiveComponent* TranslateX; // 0x2f0(0x08)
	struct UPrimitiveComponent* TranslateY; // 0x2f8(0x08)
	struct UPrimitiveComponent* TranslateZ; // 0x300(0x08)
	struct UPrimitiveComponent* TranslateYZ; // 0x308(0x08)
	struct UPrimitiveComponent* TranslateXZ; // 0x310(0x08)
	struct UPrimitiveComponent* TranslateXY; // 0x318(0x08)
	struct UPrimitiveComponent* RotateX; // 0x320(0x08)
	struct UPrimitiveComponent* RotateY; // 0x328(0x08)
	struct UPrimitiveComponent* RotateZ; // 0x330(0x08)
	struct UPrimitiveComponent* UniformScale; // 0x338(0x08)
	struct UPrimitiveComponent* AxisScaleX; // 0x340(0x08)
	struct UPrimitiveComponent* AxisScaleY; // 0x348(0x08)
	struct UPrimitiveComponent* AxisScaleZ; // 0x350(0x08)
	struct UPrimitiveComponent* PlaneScaleYZ; // 0x358(0x08)
	struct UPrimitiveComponent* PlaneScaleXZ; // 0x360(0x08)
	struct UPrimitiveComponent* PlaneScaleXY; // 0x368(0x08)
};
...
struct UTransformGizmo : UInteractiveGizmo {
	...
	char UnknownData_48_0 : 7; // 0x48(0x01)
	bool bSnapToWorldGrid : 1; // 0x48(0x01)
	char UnknownData_49_0 : 7; // 0x49(0x01)
	bool bUseContextCoordinateSystem : 1; // 0x49(0x01)
...
struct UTransformProxy : UObject {
	...
	bool bRotatePerObject : 1; // 0x70(0x01)
	char UnknownData_71_0 : 7; // 0x71(0x01)
	bool bSetPivotMode : 1; // 0x71(0x01)
...
struct UGizmoComponentWorldTransformSource : UGizmoBaseTransformSource {
	...
	bool bModifyComponentOnTransform : 1; // 0x50(0x01)
