...
struct UConsoleSettings : UObject {
	...
	bool bOrderTopToBottom : 1; // 0x54(0x01)
	char UnknownData_55_0 : 7; // 0x55(0x01)
	bool bDisplayHelpInAutoComplete : 1; // 0x55(0x01)
...
struct UGameMapsSettings : UObject {
	...
	bool bUseSplitscreen : 1; // 0x50(0x01)
	...
	char UnknownData_54_0 : 7; // 0x54(0x01)
	bool bOffsetPlayerGamepadIds : 1; // 0x54(0x01)
	...
	void SetSkipAssigningGamepadToPlayer1(bool bSkipFirstPlayer); // Function EngineSettings.GameMapsSettings.SetSkipAssigningGamepadToPlayer1 // (Final|Native|Public|BlueprintCallable) // @ game+0x21f8890
	bool GetSkipAssigningGamepadToPlayer1(); // Function EngineSettings.GameMapsSettings.GetSkipAssigningGamepadToPlayer1 // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x21f8860
	struct UGameMapsSettings* GetGameMapsSettings(); // Function EngineSettings.GameMapsSettings.GetGameMapsSettings // (Final|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x21f8830
};
...
struct UGeneralProjectSettings : UObject {
	...
	bool bShouldWindowPreserveAspectRatio : 1; // 0x108(0x01)
	char UnknownData_109_0 : 7; // 0x109(0x01)
	bool bUseBorderlessWindow : 1; // 0x109(0x01)
	char UnknownData_10A_0 : 7; // 0x10a(0x01)
	bool bStartInVR : 1; // 0x10a(0x01)
	char UnknownData_10B_0 : 7; // 0x10b(0x01)
	bool bStartInAR : 1; // 0x10b(0x01)
	char UnknownData_10C_0 : 7; // 0x10c(0x01)
	bool bSupportAR : 1; // 0x10c(0x01)
	char UnknownData_10D_0 : 7; // 0x10d(0x01)
	bool bAllowWindowResize : 1; // 0x10d(0x01)
	char UnknownData_10E_0 : 7; // 0x10e(0x01)
	bool bAllowClose : 1; // 0x10e(0x01)
	char UnknownData_10F_0 : 7; // 0x10f(0x01)
	bool bAllowMaximize : 1; // 0x10f(0x01)
	char UnknownData_110_0 : 7; // 0x110(0x01)
	bool bAllowMinimize : 1; // 0x110(0x01)
