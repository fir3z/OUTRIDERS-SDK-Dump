...
struct FModularSynthPreset : FTableRowBase {
	...
	char UnknownData_94_2 : 6; // 0x94(0x01)
...
struct FSourceEffectEnvelopeFollowerSettings {
	...
	bool bIsAnalogMode : 1; // 0x09(0x01)
...
struct FSourceEffectPhaserSettings {
	...
	bool UseQuadraturePhase : 1; // 0x0d(0x01)
...
struct FSubmixEffectConvolutionReverbSettings {
	...
	bool bInvertRearChannelBleedPhase : 1; // 0x08(0x01)
	char UnknownData_9_0 : 7; // 0x09(0x01)
	bool bSurroundRearChannelFlip : 1; // 0x09(0x01)
	char UnknownData_A[0x2]; // 0x0a(0x02)
	...
	bool AllowHArdwareAcceleration : 1; // 0x18(0x01)
