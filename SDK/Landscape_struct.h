...
struct FLandscapeLayer {
	...
	bool bVisible : 1; // 0x18(0x01)
	char UnknownData_19_0 : 7; // 0x19(0x01)
	bool Blocked : 1; // 0x19(0x01)
...
struct FWeightmapLayerAllocationInfo {
	...
	enum class None WeightmapTextureIndex; // 0x08(0x01)
	enum class None WeightmapTextureChannel; // 0x09(0x01)
...
struct FGrassVariety {
	...
	bool RandomRotation : 1; // 0x3c(0x01)
	char UnknownData_3D_0 : 7; // 0x3d(0x01)
	bool AlignToSurface : 1; // 0x3d(0x01)
	char UnknownData_3E_0 : 7; // 0x3e(0x01)
	bool bUseLandscapeLightmap : 1; // 0x3e(0x01)
	struct FLightingChannels LightingChannels; // 0x3f(0x01)
	char UnknownData_40_0 : 7; // 0x40(0x01)
	bool bReceivesDecals : 1; // 0x40(0x01)
	struct FDecalChannels DecalChannels; // 0x41(0x01)
	char UnknownData_42_0 : 7; // 0x42(0x01)
	bool bCastDynamicShadow : 1; // 0x42(0x01)
	char UnknownData_43_0 : 7; // 0x43(0x01)
	bool bKeepInstanceBufferCPUCopy : 1; // 0x43(0x01)
...
struct FGrassInput {
	...
	char UnknownData_1C[0xc]; // 0x1c(0x0c)
};
...
struct FLayerBlendInput {
	...
	char UnknownData_2C[0x8]; // 0x2c(0x08)
