...
struct FJoinabilitySettings {
	...
	bool bPublicSearchable : 1; // 0x08(0x01)
	char UnknownData_9_0 : 7; // 0x09(0x01)
	bool bAllowInvites : 1; // 0x09(0x01)
	char UnknownData_A_0 : 7; // 0x0a(0x01)
	bool bJoinViaPresence : 1; // 0x0a(0x01)
	char UnknownData_B_0 : 7; // 0x0b(0x01)
	bool bJoinViaPresenceFriendsOnly : 1; // 0x0b(0x01)
...
struct FPackedNormal {
	enum class None X; // 0x00(0x01)
	enum class None Y; // 0x01(0x01)
	enum class None Z; // 0x02(0x01)
	enum class None W; // 0x03(0x01)
};
...
// Size: 0x04 (Inherited: 0x00)
struct FColor {
	enum class None B; // 0x00(0x01)
	enum class None G; // 0x01(0x01)
	enum class None R; // 0x02(0x01)
	enum class None A; // 0x03(0x01)
};
...
struct FBox {
	...
	enum class None IsValid; // 0x18(0x01)
...
struct FBox2D {
	...
	enum class None bIsValid; // 0x10(0x01)
...
struct FTimecode {
	...
	char UnknownData_10_0 : 7; // 0x10(0x01)
	bool bDropFrameFormat : 1; // 0x10(0x01)
	char UnknownData_11[0x3]; // 0x11(0x03)
};
...
struct FPolyglotTextData {
	...
	bool bIsMinimalPatch : 1; // 0x98(0x01)
