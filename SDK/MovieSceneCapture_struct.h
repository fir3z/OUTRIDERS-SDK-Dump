...
struct FMovieSceneCaptureSettings {
	...
	bool bEnableTextureStreaming : 1; // 0x60(0x01)
	char UnknownData_61_0 : 7; // 0x61(0x01)
	bool bCinematicEngineScalability : 1; // 0x61(0x01)
	char UnknownData_62_0 : 7; // 0x62(0x01)
	bool bCinematicMode : 1; // 0x62(0x01)
	char UnknownData_63_0 : 7; // 0x63(0x01)
	bool bAllowMovement : 1; // 0x63(0x01)
	char UnknownData_64_0 : 7; // 0x64(0x01)
	bool bAllowTurning : 1; // 0x64(0x01)
	char UnknownData_65_0 : 7; // 0x65(0x01)
	bool bShowPlayer : 1; // 0x65(0x01)
	char UnknownData_66_0 : 7; // 0x66(0x01)
	bool bShowHUD : 1; // 0x66(0x01)
	char UnknownData_67_0 : 7; // 0x67(0x01)
	bool bUsePathTracer : 1; // 0x67(0x01)
