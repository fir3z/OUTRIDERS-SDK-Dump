// Enum OnlineSubsystem.ESessionChange
enum class ESessionChange : uint8 {
	Nothing,
	SessionSetting,
	SessionOwner,
	SessionId,
	CustomSessionSetting,
	JoinabilitySetting,
	MemberList,
	MemberSetting,
	Max,
...
// Enum OnlineSubsystem.EPlayerVoiceStatus
enum class EPlayerVoiceStatus : uint8 {
	Error,
	Silent,
	Talking,
	Muted,
	MicDisconnected,
	EPlayerVoiceStatus_MAX,
};
...
struct FInAppPurchaseProductRequest {
	...
	bool bIsConsumable : 1; // 0x10(0x01)
