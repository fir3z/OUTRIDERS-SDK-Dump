...
struct FMovieScene3DTransformTemplateData {
	...
	char UnknownData_648_0 : 7; // 0x648(0x01)
	bool bUseQuaternionInterpolation : 1; // 0x648(0x01)
...
struct FMovieSceneCameraCutSectionTemplate : FMovieSceneEvalTemplate {
	...
	bool bHasCutTransform : 1; // 0x70(0x01)
	char UnknownData_71_0 : 7; // 0x71(0x01)
	bool bIsFinalSection : 1; // 0x71(0x01)
...
struct FMovieSceneStringChannel : FMovieSceneChannel {
	...
	bool bHasDefaultValue : 1; // 0x38(0x01)
...
struct FMovieSceneSkeletalAnimationParams {
	...
	struct TSoftObjectPtr<struct UAnimSequenceBase> AnimationPtr; // 0x08(0x28)
	struct FFrameNumber FirstLoopStartFrameOffset; // 0x30(0x04)
	struct FFrameNumber StartFrameOffset; // 0x34(0x04)
	struct FFrameNumber EndFrameOffset; // 0x38(0x04)
	float PlayRate; // 0x3c(0x04)
	char bReverse : 1; // 0x40(0x01)
	char UnknownData_40_1 : 7; // 0x40(0x01)
	char UnknownData_41[0x3]; // 0x41(0x03)
	struct FName SlotName; // 0x44(0x08)
	char UnknownData_4C[0x4]; // 0x4c(0x04)
	struct FMovieSceneFloatChannel Weight; // 0x50(0xa0)
	char UnknownData_F0_0 : 7; // 0xf0(0x01)
	bool bSkipAnimNotifiers : 1; // 0xf0(0x01)
	char UnknownData_F1_0 : 7; // 0xf1(0x01)
	bool bForceCustomMode : 1; // 0xf1(0x01)
	char UnknownData_F2[0x2]; // 0xf2(0x02)
	float StartOffset; // 0xf4(0x04)
	float EndOffset; // 0xf8(0x04)
...
struct FMovieSceneSkeletalAnimationSectionTemplate : FMovieSceneEvalTemplate {
	struct FMovieSceneSkeletalAnimationSectionTemplateParameters Params; // 0x20(0x108)
	struct UMovieSceneSkeletalAnimationSection* SectionPtr; // 0x128(0x08)
};
...
struct FMovieSceneSkeletalAnimationSectionTemplateParameters : FMovieSceneSkeletalAnimationParams {
	struct FFrameNumber SectionStartTime; // 0x100(0x04)
	struct FFrameNumber SectionEndTime; // 0x104(0x04)
};
