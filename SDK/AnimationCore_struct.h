...
struct FAxis {
	...
	bool bInLocalSpace : 1; // 0x0c(0x01)
...
struct FConstraintData {
	...
	bool bMaintainOffset : 1; // 0x14(0x01)
...
struct FTransformConstraint {
	...
	bool bMaintainOffset : 1; // 0x24(0x01)
...
struct FConstraintDescription {
	char UnknownData_0_0 : 7; // 0x00(0x01)
	bool bTranslation : 1; // 0x00(0x01)
	char UnknownData_1_0 : 7; // 0x01(0x01)
	bool bRotation : 1; // 0x01(0x01)
	char UnknownData_2_0 : 7; // 0x02(0x01)
	bool bScale : 1; // 0x02(0x01)
	char UnknownData_3_0 : 7; // 0x03(0x01)
	bool bParent : 1; // 0x03(0x01)
