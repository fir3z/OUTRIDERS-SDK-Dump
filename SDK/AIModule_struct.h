...
// Enum AIModule.EAIForceParam
enum class EAIForceParam : uint8 {
	Force,
	DoNotForce,
	MAX,
};
...
// ScriptStruct AIModule.FocusKnowledge
// Size: 0x10 (Inherited: 0x00)
struct FFocusKnowledge {
	struct TArray<struct FFocusKnowledgeFocusItem> Priorities; // 0x00(0x10)
};

// ScriptStruct AIModule.FocusKnowledgeFocusItem
// Size: 0x18 (Inherited: 0x00)
struct FFocusKnowledgeFocusItem {
...
struct FBlackboardKeySelector {
	...
	enum class None SelectedKeyID; // 0x20(0x01)
...
// ScriptStruct AIModule.ActorPerceptionInfo
// Size: 0x28 (Inherited: 0x00)
...
// ScriptStruct AIModule.PerceptionListener
// Size: 0x30 (Inherited: 0x00)
struct FPerceptionListener {
	struct UAIPerceptionComponent* Listener; // 0x00(0x08)
...
struct FAISenseAffiliationFilter {
	...
	char bDetectFriendlyAI : 1; // 0x00(0x01)
	char bDetectFriendlyPlayers : 1; // 0x00(0x01)
...
struct FCrowdAvoidanceConfig {
	...
	enum class None CustomPatternIdx; // 0x18(0x01)
	enum class None AdaptiveDivisions; // 0x19(0x01)
	enum class None AdaptiveRings; // 0x1a(0x01)
	enum class None AdaptiveDepth; // 0x1b(0x01)
};
...
struct FEnvQueryInstanceCache {
	...
	char UnknownData_8[0x1a0]; // 0x08(0x1a0)
};
...
struct FGenericTeamId {
	enum class None TeamID; // 0x00(0x01)
};
