...
struct FStructSerializerObjectTestStruct {
	...
	struct FWeakObjectPtr<struct UMetaData> WeakObject; // 0x40(0x08)
...
struct FStructSerializerBooleanTestStruct {
	...
	bool BoolFalse : 1; // 0x00(0x01)
	char UnknownData_1_0 : 7; // 0x01(0x01)
	bool BoolTrue : 1; // 0x01(0x01)
...
struct FStructSerializerNumericTestStruct {
	...
	enum class None UInt8; // 0x10(0x01)
...
struct FStructSerializerByteArray {
	...
	struct TArray<enum class None> ByteArray; // 0x08(0x10)
