...
struct FSlateBrush {
	...
	char UnknownData_80_2 : 6; // 0x80(0x01)
...
struct FFontOutlineSettings {
	...
	bool bSeparateFillAlpha : 1; // 0x04(0x01)
	char UnknownData_5_0 : 7; // 0x05(0x01)
	bool bApplyOutlineToDropShadows : 1; // 0x05(0x01)
...
struct FSearchBoxStyle : FSlateWidgetStyle {
	...
	char UnknownData_A78_0 : 7; // 0xa78(0x01)
	bool bLeftAlignButtons : 1; // 0xa78(0x01)
	char UnknownData_A79[0x7]; // 0xa79(0x07)
};
