...
enum class ETickingGroup : uint8 {
	TG_PrePrePhysicsWrite,
	TG_PrePhysics,
	TG_PostPrePhysicsWrite,
	TG_StartPhysics,
	TG_DuringPhysics,
	TG_EndPhysics,
	TG_PostPhysics,
...
// Enum Engine.EExplosionDirectionType
enum class EExplosionDirectionType : uint8 {
	OriginToBone,
	HitDirection,
	EExplosionDirectionType_MAX,
};

// Enum Engine.EExplosionOriginType
enum class EExplosionOriginType : uint8 {
	DamageCauser,
	HitResult,
	BoneLocation,
	EExplosionOriginType_MAX,
};
...
// Enum Engine.EAsyncUnregisterStatus
enum class EAsyncUnregisterStatus : uint8 {
	NotRequired,
	NotTriggered,
	Waiting,
	Complete,
	EAsyncUnregisterStatus_MAX,
};
...
// Enum Engine.LODBlendState
enum class LODBlendState : uint8 {
	NotBlending,
	BlendOngoing,
	FinishedBlendIn,
	FinishedBlendOut,
...
// Enum Engine.EBlendLessRangeSkipType
enum class EBlendLessRangeSkipType : uint8 {
	RoundToTheRangeBoundaries,
	BlendToRangeStart,
	BlendToRangeEnd,
	EBlendLessRangeSkipType_MAX,
};
...
// Enum Engine.ECloudsCheckerboard
enum class ECloudsCheckerboard : uint8 {
	EveryTexel,
	Every2nd,
	Every4th,
	ECloudsCheckerboard_MAX,
};
...
// Enum Engine.EGoreSlot
enum class EGoreSlot : uint8 {
	UnknownGoreSlot,
	lowerarm_r,
	lowerarm_l,
	calf_r,
...
// Enum Engine.ERelativeTransform
enum class ERelativeTransform : uint8 {
	BoneRelative,
	WorldRelative,
	ActorRelative,
	ERelativeTransform_MAX,
};
...
// Enum Engine.EWindGustTextureChannel
enum class EWindGustTextureChannel : uint8 {
	Red,
	Green,
	Blue,
	Alpha,
	EWindGustTextureChannel_MAX,
};
...
// Enum Engine.EEmitterRoleVisibility
enum class EEmitterRoleVisibility : uint8 {
	ERV_Normal,
	ERV_Local,
	ERV_Other,
	ERV_MAX,
...
// Enum Engine.EDecalRotationMode
...
// Enum Engine.EBoneHidingMethod
enum class EBoneHidingMethod : uint8 {
	BHM_Zero_Scale,
...
// Enum Engine.EPhysicalMaterialBlendType
enum class EPhysicalMaterialBlendType : uint8 {
	Half,
	Any,
	All,
	EPhysicalMaterialBlendType_MAX,
};

// Enum Engine.EPhysicalMaterialVertexChannel
enum class EPhysicalMaterialVertexChannel : uint8 {
	Background,
	Red,
	Green,
	Blue,
	...
	InvBlue,
	InvAlpha,
	EPhysicalMaterialVertexChannel_MAX,
};
...
struct FDistributionLookupTable {
	...
	enum class None Op; // 0x18(0x01)
	enum class None EntryCount; // 0x19(0x01)
	enum class None EntryStride; // 0x1a(0x01)
	enum class None SubEntryStride; // 0x1b(0x01)
	enum class None LockFlag; // 0x1c(0x01)
...
struct FHitResult {
	...
	struct FName OtherBoneName; // 0x88(0x08)
};
...
struct FTickFunction {
	...
	float TickInterval; // 0x08(0x04)
	char UnknownData_C[0xdc]; // 0x0c(0xdc)
	enum class ETickingGroup TickGroup; // 0xe8(0x01)
	enum class ETickingGroup EndTickGroup; // 0xe9(0x01)
	char UnknownData_EA[0x1]; // 0xea(0x01)
	char bTickEvenWhenPaused : 1; // 0xeb(0x01)
	char bCanEverTick : 1; // 0xeb(0x01)
	char bStartWithTickEnabled : 1; // 0xeb(0x01)
	char bAllowTickOnDedicatedServer : 1; // 0xeb(0x01)
	char UnknownData_EB_4 : 4; // 0xeb(0x01)
...
struct FInterpControlPoint {
	...
	bool bPositionIsRelative : 1; // 0x0c(0x01)
...
struct FDebugFloatHistory {
	...
	bool bAutoAdjustMinMax : 1; // 0x1c(0x01)
	char UnknownData_1D[0x3]; // 0x1d(0x03)
};
...
struct FPointDamageEvent : FDamageEvent {
	...
	struct FHitResult HitInfo; // 0x20(0x90)
};
...
struct FForceFeedbackParameters {
	...
	bool bLooping : 1; // 0x08(0x01)
	char UnknownData_9_0 : 7; // 0x09(0x01)
	bool bIgnoreTimeDilation : 1; // 0x09(0x01)
	char UnknownData_A_0 : 7; // 0x0a(0x01)
	bool bPlayWhilePaused : 1; // 0x0a(0x01)
...
struct FRootMotionSourceSettings {
	enum class None Flags; // 0x00(0x01)
};
...
struct FRepRootMotionMontage {
	...
	bool bRelativePosition : 1; // 0x40(0x01)
	char UnknownData_41_0 : 7; // 0x41(0x01)
	bool bRelativeRotation : 1; // 0x41(0x01)
...
struct FRootMotionMovementParams {
	char UnknownData_0_0 : 7; // 0x00(0x01)
	bool bHasRootMotion : 1; // 0x00(0x01)
	char UnknownData_1[0x3]; // 0x01(0x03)
...
struct FBasedMovementInfo {
	...
	bool bServerHasBaseComponent : 1; // 0x28(0x01)
	char UnknownData_29_0 : 7; // 0x29(0x01)
	bool bRelativeRotation : 1; // 0x29(0x01)
	char UnknownData_2A_0 : 7; // 0x2a(0x01)
	bool bServerHasVelocity : 1; // 0x2a(0x01)
	char UnknownData_2B[0x5]; // 0x2b(0x05)
};

// ScriptStruct Engine.ExplosionParameter
// Size: 0x2c (Inherited: 0x00)
struct FExplosionParameter {
	char UnknownData_0_0 : 7; // 0x00(0x01)
	bool bConical : 1; // 0x00(0x01)
	char UnknownData_1_0 : 7; // 0x01(0x01)
	bool bInvertDirection : 1; // 0x01(0x01)
	char UnknownData_2[0x2]; // 0x02(0x02)
	float ConeHalfAngle; // 0x04(0x04)
	float MinImpulse; // 0x08(0x04)
	float MaxImpulse; // 0x0c(0x04)
	struct FVector_NetQuantize ExplosionOffsetInLocalSpace; // 0x10(0x0c)
	enum class EExplosionOriginType ExplosionOriginType; // 0x1c(0x01)
	char UnknownData_1D[0x3]; // 0x1d(0x03)
	struct FName BoneName; // 0x20(0x08)
	enum class EExplosionDirectionType ExplosionDirectionType; // 0x28(0x01)
	char UnknownData_29_0 : 7; // 0x29(0x01)
	bool bGibRandomNumberOfBones : 1; // 0x29(0x01)
	char UnknownData_2A[0x2]; // 0x2a(0x02)
};
...
struct FBodyInstance {
	...
	enum class None PositionSolverIterationCount; // 0x24(0x01)
	enum class None VelocitySolverIterationCount; // 0x25(0x01)
...
struct FInputScaleBiasClamp {
	char UnknownData_0_0 : 7; // 0x00(0x01)
	bool bMapRange : 1; // 0x00(0x01)
	char UnknownData_1_0 : 7; // 0x01(0x01)
	bool bClampResult : 1; // 0x01(0x01)
	char UnknownData_2_0 : 7; // 0x02(0x01)
	bool bInterpResult : 1; // 0x02(0x01)
...
// ScriptStruct Engine.LODBlendProperties
// Size: 0x0c (Inherited: 0x00)
struct FLODBlendProperties {
	int32_t LODThreshold; // 0x00(0x04)
	float BlendSpeed; // 0x04(0x04)
...
struct FAnimNode_AssetPlayerBase : FAnimNode_Base {
	...
	bool bIgnoreForRelevancyTest : 1; // 0x15(0x01)
...
struct FAnimationRecordingSettings {
	char UnknownData_0_0 : 7; // 0x00(0x01)
	bool bRecordInWorldSpace : 1; // 0x00(0x01)
	char UnknownData_1_0 : 7; // 0x01(0x01)
	bool bRemoveRootAnimation : 1; // 0x01(0x01)
	char UnknownData_2_0 : 7; // 0x02(0x01)
	bool bAutoSaveAsset : 1; // 0x02(0x01)
	char UnknownData_3[0x1]; // 0x03(0x01)
...
struct FQueuedDrawDebugItem {
	...
	bool bPersistentLines : 1; // 0x44(0x01)
...
struct FAnimMontageInstance {
	...
	char UnknownData_198_0 : 7; // 0x198(0x01)
	bool bDisableRootMotion : 1; // 0x198(0x01)
	char UnknownData_199[0x27]; // 0x199(0x27)
};
...
struct FAnimNotifyEvent : FAnimLinkableElement {
	...
	bool bConvertedFromBranchingPoint : 1; // 0x90(0x01)
	...
	bool bTriggerOnDedicatedServer : 1; // 0xa0(0x01)
	char UnknownData_A1_0 : 7; // 0xa1(0x01)
	bool bTriggerOnFollower : 1; // 0xa1(0x01)
...
struct FAnimNode_SequencePlayer : FAnimNode_AssetPlayerBase {
	...
	bool bLoopAnimation : 1; // 0x74(0x01)
...
struct FAnimNode_StateMachine : FAnimNode_Base {
	...
	bool bSkipFirstUpdateTransition : 1; // 0x18(0x01)
	char UnknownData_19_0 : 7; // 0x19(0x01)
	bool bReinitializeOnBecomingRelevant : 1; // 0x19(0x01)
...
struct FAnimNode_TransitionResult : FAnimNode_Base {
	...
	bool bCanEnterTransition : 1; // 0x10(0x01)
...
struct FExposedValueCopyRecord {
	...
	bool bInstanceIsTarget : 1; // 0x14(0x01)
...
struct FCompressedTrack {
	struct TArray<enum class None> ByteStream; // 0x00(0x10)
...
struct FBakedAnimationState {
	...
	bool bAlwaysResetOnEntry : 1; // 0x50(0x01)
	char UnknownData_51[0x7]; // 0x51(0x07)
	struct TArray<int32_t> AllNodeIndices; // 0x58(0x10)
};
...
struct FBakedStateExitTransition {
	...
	char UnknownData_C_0 : 7; // 0x0c(0x01)
	bool bDesiredTransitionReturnValue : 1; // 0x0c(0x01)
	char UnknownData_D_0 : 7; // 0x0d(0x01)
	bool bAutomaticRemainingTimeRule : 1; // 0x0d(0x01)
	char UnknownData_E[0x2]; // 0x0e(0x02)
...
struct FAnimationTransitionRule {
	...
	char UnknownData_8_0 : 7; // 0x08(0x01)
	bool TransitionReturnVal : 1; // 0x08(0x01)
	char UnknownData_9[0x3]; // 0x09(0x03)
...
struct FPrimaryAssetRules {
	...
	char UnknownData_8_0 : 7; // 0x08(0x01)
	bool bApplyRecursively : 1; // 0x08(0x01)
...
struct FPrimaryAssetTypeInfo {
	...
	bool bHasBlueprintClasses : 1; // 0x38(0x01)
	char UnknownData_39_0 : 7; // 0x39(0x01)
	bool bIsEditorOnly : 1; // 0x39(0x01)
	...
	bool bIsDynamicAsset : 1; // 0x80(0x01)
...
struct FInteriorSettings {
	char UnknownData_0_0 : 7; // 0x00(0x01)
	bool bIsWorldSettings : 1; // 0x00(0x01)
	char UnknownData_1[0x3]; // 0x01(0x03)
...
struct FBandwidthTestItem {
	struct TArray<enum class None> Kilobyte; // 0x00(0x10)
};
...
// ScriptStruct Engine.BlendLessRange
// Size: 0x0c (Inherited: 0x00)
struct FBlendLessRange {
	float BlendLessRangeStart; // 0x00(0x04)
	float BlendLessRangeEnd; // 0x04(0x04)
	enum class EBlendLessRangeSkipType RangeSkipType; // 0x08(0x01)
	char UnknownData_9[0x3]; // 0x09(0x03)
};
...
struct FBPVariableDescription {
	...
	struct FEdGraphPinType VarType; // 0x18(0x60)
	struct FString FriendlyName; // 0x78(0x10)
	struct FText Category; // 0x88(0x18)
	uint64_t PropertyFlags; // 0xa0(0x08)
	struct FName RepNotifyFunc; // 0xa8(0x08)
	enum class ELifetimeCondition ReplicationCondition; // 0xb0(0x01)
...
struct FEdGraphPinType {
	...
	struct FEdGraphTerminalType PinValueType; // 0x38(0x20)
	enum class EPinContainerType ContainerType; // 0x58(0x01)
	char bIsArray : 1; // 0x59(0x01)
	char bIsReference : 1; // 0x59(0x01)
	char bIsConst : 1; // 0x59(0x01)
	char bIsWeakPointer : 1; // 0x59(0x01)
	char UnknownData_59_4 : 4; // 0x59(0x01)
...
struct FEdGraphTerminalType {
	...
	char UnknownData_18_0 : 7; // 0x18(0x01)
	bool bTerminalIsConst : 1; // 0x18(0x01)
	char UnknownData_19_0 : 7; // 0x19(0x01)
	bool bTerminalIsWeakPointer : 1; // 0x19(0x01)
...
struct FCompilerNativizationOptions {
	...
	char UnknownData_8_0 : 7; // 0x08(0x01)
	bool ServerOnlyPlatform : 1; // 0x08(0x01)
	char UnknownData_9_0 : 7; // 0x09(0x01)
	bool ClientOnlyPlatform : 1; // 0x09(0x01)
	char UnknownData_A_0 : 7; // 0x0a(0x01)
	bool bExcludeMonolithicHeaders : 1; // 0x0a(0x01)
...
struct FBlueprintCookedComponentInstancingData {
	...
	bool bHasValidCookedData : 1; // 0x21(0x01)
...
struct FPostProcessSettings {
	...
	char UnknownData_16_1 : 7; // 0x16(0x01)
	char UnknownData_17[0x1]; // 0x17(0x01)
	char bOverride_BoostCharacterIndirectIntensity : 1; // 0x18(0x01)
	char UnknownData_18_1 : 7; // 0x18(0x01)
	char UnknownData_19[0x3]; // 0x19(0x03)
	char bOverride_ColorGradingIntensity : 1; // 0x1c(0x01)
	char bOverride_ColorGradingLUT : 1; // 0x1c(0x01)
	char bOverride_DepthOfFieldFocalDistance : 1; // 0x1c(0x01)
	char bOverride_DepthOfFieldFstop : 1; // 0x1c(0x01)
	char bOverride_DepthOfFieldMinFstop : 1; // 0x1c(0x01)
	char bOverride_DepthOfFieldBladeCount : 1; // 0x1c(0x01)
	char bOverride_DepthOfFieldSensorWidth : 1; // 0x1c(0x01)
	char bOverride_DepthOfFieldDepthBlurRadius : 1; // 0x1c(0x01)
	char bOverride_DepthOfFieldDepthBlurAmount : 1; // 0x1d(0x01)
	char bOverride_DepthOfFieldFocalRegion : 1; // 0x1d(0x01)
	char bOverride_DepthOfFieldNearTransitionRegion : 1; // 0x1d(0x01)
	char bOverride_DepthOfFieldFarTransitionRegion : 1; // 0x1d(0x01)
	char bOverride_DepthOfFieldScale : 1; // 0x1d(0x01)
	char bOverride_DepthOfFieldNearBlurSize : 1; // 0x1d(0x01)
	char bOverride_DepthOfFieldFarBlurSize : 1; // 0x1d(0x01)
	char bOverride_MobileHQGaussian : 1; // 0x1d(0x01)
	char bOverride_DepthOfFieldOcclusion : 1; // 0x1e(0x01)
	char bOverride_DepthOfFieldSkyFocusDistance : 1; // 0x1e(0x01)
	char bOverride_DepthOfFieldVignetteSize : 1; // 0x1e(0x01)
	char bOverride_MotionBlurAmount : 1; // 0x1e(0x01)
	char bOverride_MotionBlurMax : 1; // 0x1e(0x01)
	char bOverride_MotionBlurTargetFPS : 1; // 0x1e(0x01)
	char bOverride_MotionBlurPerObjectSize : 1; // 0x1e(0x01)
	char bOverride_ScreenPercentage : 1; // 0x1e(0x01)
	char bOverride_ScreenSpaceReflectionIntensity : 1; // 0x1f(0x01)
	char bOverride_ScreenSpaceReflectionQuality : 1; // 0x1f(0x01)
	char bOverride_ScreenSpaceReflectionMaxRoughness : 1; // 0x1f(0x01)
	char bOverride_ScreenSpaceReflectionRoughnessScale : 1; // 0x1f(0x01)
	char UnknownData_1F_4 : 4; // 0x1f(0x01)
	char bOverride_ReflectionsType : 1; // 0x20(0x01)
	char bOverride_RayTracingReflectionsMaxRoughness : 1; // 0x20(0x01)
	char bOverride_RayTracingReflectionsMaxBounces : 1; // 0x20(0x01)
	char bOverride_RayTracingReflectionsSamplesPerPixel : 1; // 0x20(0x01)
	char bOverride_RayTracingReflectionsShadows : 1; // 0x20(0x01)
	char bOverride_RayTracingReflectionsTranslucency : 1; // 0x20(0x01)
	char bOverride_TranslucencyType : 1; // 0x20(0x01)
	char bOverride_RayTracingTranslucencyMaxRoughness : 1; // 0x20(0x01)
	char bOverride_RayTracingTranslucencyRefractionRays : 1; // 0x21(0x01)
	char bOverride_RayTracingTranslucencySamplesPerPixel : 1; // 0x21(0x01)
	char bOverride_RayTracingTranslucencyShadows : 1; // 0x21(0x01)
	char bOverride_RayTracingTranslucencyRefraction : 1; // 0x21(0x01)
	char bOverride_RayTracingGI : 1; // 0x21(0x01)
	char bOverride_RayTracingGIMaxBounces : 1; // 0x21(0x01)
	char bOverride_RayTracingGISamplesPerPixel : 1; // 0x21(0x01)
	char bOverride_PathTracingMaxBounces : 1; // 0x21(0x01)
	char bOverride_PathTracingSamplesPerPixel : 1; // 0x22(0x01)
	char UnknownData_22_1 : 7; // 0x22(0x01)
	char UnknownData_23[0x1]; // 0x23(0x01)
	char bMobileHQGaussian : 1; // 0x24(0x01)
	char UnknownData_24_1 : 7; // 0x24(0x01)
	enum class EBloomMethod BloomMethod; // 0x25(0x01)
	enum class EAutoExposureMethod AutoExposureMethod; // 0x26(0x01)
	char UnknownData_27[0x1]; // 0x27(0x01)
	float WhiteTemp; // 0x28(0x04)
	float WhiteTint; // 0x2c(0x04)
	...
	float BoostCharacterIndirectIntensity; // 0x458(0x04)
	enum class ERayTracingGlobalIlluminationType RayTracingGIType; // 0x45c(0x01)
	char UnknownData_45D[0x3]; // 0x45d(0x03)
	int32_t RayTracingGIMaxBounces; // 0x460(0x04)
	int32_t RayTracingGISamplesPerPixel; // 0x464(0x04)
	float ColorGradingIntensity; // 0x468(0x04)
	char UnknownData_46C[0x4]; // 0x46c(0x04)
	struct UTexture* ColorGradingLUT; // 0x470(0x08)
	float DepthOfFieldSensorWidth; // 0x478(0x04)
	float DepthOfFieldFocalDistance; // 0x47c(0x04)
	float DepthOfFieldDepthBlurAmount; // 0x480(0x04)
	float DepthOfFieldDepthBlurRadius; // 0x484(0x04)
	float DepthOfFieldFocalRegion; // 0x488(0x04)
	float DepthOfFieldNearTransitionRegion; // 0x48c(0x04)
	float DepthOfFieldFarTransitionRegion; // 0x490(0x04)
	float DepthOfFieldScale; // 0x494(0x04)
	float DepthOfFieldNearBlurSize; // 0x498(0x04)
	float DepthOfFieldFarBlurSize; // 0x49c(0x04)
	float DepthOfFieldOcclusion; // 0x4a0(0x04)
	float DepthOfFieldSkyFocusDistance; // 0x4a4(0x04)
	float DepthOfFieldVignetteSize; // 0x4a8(0x04)
	float MotionBlurAmount; // 0x4ac(0x04)
	float MotionBlurMax; // 0x4b0(0x04)
	int32_t MotionBlurTargetFPS; // 0x4b4(0x04)
	float MotionBlurPerObjectSize; // 0x4b8(0x04)
	float LPVIntensity; // 0x4bc(0x04)
	float LPVVplInjectionBias; // 0x4c0(0x04)
	float LPVSize; // 0x4c4(0x04)
	float LPVSecondaryOcclusionIntensity; // 0x4c8(0x04)
	float LPVSecondaryBounceIntensity; // 0x4cc(0x04)
	float LPVGeometryVolumeBias; // 0x4d0(0x04)
	float LPVEmissiveInjectionIntensity; // 0x4d4(0x04)
	float LPVDirectionalOcclusionIntensity; // 0x4d8(0x04)
	float LPVDirectionalOcclusionRadius; // 0x4dc(0x04)
	float LPVDiffuseOcclusionExponent; // 0x4e0(0x04)
	float LPVSpecularOcclusionExponent; // 0x4e4(0x04)
	float LPVDiffuseOcclusionIntensity; // 0x4e8(0x04)
	float LPVSpecularOcclusionIntensity; // 0x4ec(0x04)
	enum class EReflectionsType ReflectionsType; // 0x4f0(0x01)
	char UnknownData_4F1[0x3]; // 0x4f1(0x03)
	float ScreenSpaceReflectionIntensity; // 0x4f4(0x04)
	float ScreenSpaceReflectionQuality; // 0x4f8(0x04)
	float ScreenSpaceReflectionMaxRoughness; // 0x4fc(0x04)
	float RayTracingReflectionsMaxRoughness; // 0x500(0x04)
	int32_t RayTracingReflectionsMaxBounces; // 0x504(0x04)
	int32_t RayTracingReflectionsSamplesPerPixel; // 0x508(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingReflectionsShadows; // 0x50c(0x01)
	char RayTracingReflectionsTranslucency : 1; // 0x50d(0x01)
	char UnknownData_50D_1 : 7; // 0x50d(0x01)
	enum class ETranslucencyType TranslucencyType; // 0x50e(0x01)
	char UnknownData_50F[0x1]; // 0x50f(0x01)
	float RayTracingTranslucencyMaxRoughness; // 0x510(0x04)
	int32_t RayTracingTranslucencyRefractionRays; // 0x514(0x04)
	int32_t RayTracingTranslucencySamplesPerPixel; // 0x518(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingTranslucencyShadows; // 0x51c(0x01)
	char RayTracingTranslucencyRefraction : 1; // 0x51d(0x01)
	char UnknownData_51D_1 : 7; // 0x51d(0x01)
	char UnknownData_51E[0x2]; // 0x51e(0x02)
	int32_t PathTracingMaxBounces; // 0x520(0x04)
	int32_t PathTracingSamplesPerPixel; // 0x524(0x04)
	float LPVFadeRange; // 0x528(0x04)
	float LPVDirectionalOcclusionFadeRange; // 0x52c(0x04)
	float ScreenPercentage; // 0x530(0x04)
	char UnknownData_534[0x4]; // 0x534(0x04)
	struct FWeightedBlendables WeightedBlendables; // 0x538(0x10)
...
// ScriptStruct Engine.CloudsData
// Size: 0x100 (Inherited: 0x00)
struct FCloudsData {
	struct FVector NoiseFrequency; // 0x00(0x0c)
	float Coverage; // 0x0c(0x04)
	float Density; // 0x10(0x04)
	float ForwardScatter; // 0x14(0x04)
	float BackScatter; // 0x18(0x04)
	float MaxSteps; // 0x1c(0x04)
	float LightDistance; // 0x20(0x04)
	float Top; // 0x24(0x04)
	float Bottom; // 0x28(0x04)
	float SunIntensity; // 0x2c(0x04)
	float AmbientIntensity; // 0x30(0x04)
	struct FVector Speed; // 0x34(0x0c)
	struct FVector MovementDirection; // 0x40(0x0c)
	struct FLinearColor AmbientTop; // 0x4c(0x10)
	struct FLinearColor AmbientBottom; // 0x5c(0x10)
	float MipDistance; // 0x6c(0x04)
	float MipModeThreshold; // 0x70(0x04)
	float CloudBottomFade; // 0x74(0x04)
	float SampleDensity; // 0x78(0x04)
	char UnknownData_7C[0x4]; // 0x7c(0x04)
	struct FVector4 Gradient1; // 0x80(0x10)
	struct FVector4 Gradient2; // 0x90(0x10)
	struct FVector4 Gradient3; // 0xa0(0x10)
	struct UTexture2D* CoverageTex; // 0xb0(0x08)
	struct UTexture2D* CloudNoiseTex; // 0xb8(0x08)
	struct UTexture2D* CloudDetailTex; // 0xc0(0x08)
	struct FVector CloudSphereCenter; // 0xc8(0x0c)
	float CloudSphereRadius; // 0xd4(0x04)
	float DirectShadow; // 0xd8(0x04)
	float AmbientShadow; // 0xdc(0x04)
	struct UTexture2DDynamic* ResultTexture; // 0xe0(0x08)
	int32_t LightSteps; // 0xe8(0x04)
	float HorizonCoverageFactor; // 0xec(0x04)
	int32_t OptimizeDetailMode; // 0xf0(0x04)
	float ViewPortDiscSize; // 0xf4(0x04)
	float BlendAlphaDistance; // 0xf8(0x04)
	enum class ECloudsCheckerboard Checkerboard; // 0xfc(0x01)
...
struct FCustomChannelSetup {
	...
	char UnknownData_2_0 : 7; // 0x02(0x01)
	bool bTraceType : 1; // 0x02(0x01)
	char UnknownData_3_0 : 7; // 0x03(0x01)
	bool bStaticObject : 1; // 0x03(0x01)
	struct FName Name; // 0x04(0x08)
};
...
struct FMeshUVChannelInfo {
	char UnknownData_0_0 : 7; // 0x00(0x01)
	bool bInitialized : 1; // 0x00(0x01)
	char UnknownData_1_0 : 7; // 0x01(0x01)
	bool bOverrideDensities : 1; // 0x01(0x01)
	char UnknownData_2[0x2]; // 0x02(0x02)
...
struct FMulticastRecordOptions {
	...
	char UnknownData_10_0 : 7; // 0x10(0x01)
	bool bServerSkip : 1; // 0x10(0x01)
	char UnknownData_11_0 : 7; // 0x11(0x01)
	bool bClientSkip : 1; // 0x11(0x01)
...
struct FStatColorMapping {
	struct FName StatShortName; // 0x00(0x08)
	struct TArray<struct FStatColorMapEntry> ColorMap; // 0x08(0x10)
	char DisableBlend : 1; // 0x18(0x01)
	char UnknownData_18_1 : 7; // 0x18(0x01)
...
struct FAnimUpdateRateParameters {
	...
	char bManuallyControllEvaluationRates : 1; // 0x02(0x01)
	char UnknownData_2_6 : 2; // 0x02(0x01)
	char UnknownData_3[0x1]; // 0x03(0x01)
...
struct FLightmassPrimitiveSettings {
	...
	char bIgnoreLandscapeShadow : 1; // 0x00(0x01)
	char UnknownData_0_5 : 3; // 0x00(0x01)
	char UnknownData_1[0x3]; // 0x01(0x03)
...
struct FLightmassLightSettings {
	...
	char UnknownData_8_0 : 7; // 0x08(0x01)
	bool bUseAreaShadowsForStationaryLight : 1; // 0x08(0x01)
	char UnknownData_9[0x3]; // 0x09(0x03)
};
...
struct FRigidBodyState {
	...
	enum class None Flags; // 0x38(0x01)
	char UnknownData_39[0x7]; // 0x39(0x07)
};
...
struct FMaterialShadingModelField {
	uint16 ShadingModelField; // 0x00(0x02)
};
...
struct FFontCharacter {
	...
	enum class None TextureIndex; // 0x10(0x01)
	char UnknownData_11[0x3]; // 0x11(0x03)
...
struct FPredictProjectilePathResult {
	...
	char UnknownData_2C[0x4]; // 0x2c(0x04)
	struct FHitResult HitResult; // 0x30(0x90)
};
...
struct FPredictProjectilePathParams {
	...
	bool bTraceComplex : 1; // 0x58(0x01)
	char UnknownData_59[0x7]; // 0x59(0x07)
};

// ScriptStruct Engine.GlobalWindModifier
// Size: 0x18 (Inherited: 0x00)
struct FGlobalWindModifier {
	struct FWeakObjectPtr<struct UCurveFloat> Curve; // 0x00(0x08)
	char UnknownData_8[0x10]; // 0x08(0x10)
};

// ScriptStruct Engine.GlobalWindInfluenceHandle
// Size: 0x01 (Inherited: 0x00)
struct FGlobalWindInfluenceHandle {
	char UnknownData_0[0x1]; // 0x00(0x01)
};

// ScriptStruct Engine.WindGustInfo
// Size: 0x18 (Inherited: 0x00)
struct FWindGustInfo {
	enum class EWindGustTextureChannel TextureChannel; // 0x00(0x04)
	float MaxSpeed; // 0x04(0x04)
	float TextureWorldSize; // 0x08(0x04)
	float TextureSpeed; // 0x0c(0x04)
	float TextureVelocityAngle; // 0x10(0x04)
	char UnknownData_14_0 : 7; // 0x14(0x01)
	bool bUsedForNonMaterialEffects : 1; // 0x14(0x01)
	char UnknownData_15[0x3]; // 0x15(0x03)
};
...
struct FHLODProxyMesh {
	LazyObjectProperty LODActor; // 0x00(0x20)
...
struct FIntegralCurve : FIndexedCurve {
	...
	bool bUseDefaultValueBeforeFirstKey : 1; // 0x7c(0x01)
...
struct FLevelSimplificationDetails {
	...
	bool bBakeFoliageToLandscape : 1; // 0x120(0x01)
	char UnknownData_121_0 : 7; // 0x121(0x01)
	bool bBakeGrassToLandscape : 1; // 0x121(0x01)
	char UnknownData_122_0 : 7; // 0x122(0x01)
	bool bGenerateMeshNormalMap : 1; // 0x122(0x01)
	char UnknownData_123_0 : 7; // 0x123(0x01)
	bool bGenerateMeshMetallicMap : 1; // 0x123(0x01)
	char UnknownData_124_0 : 7; // 0x124(0x01)
	bool bGenerateMeshRoughnessMap : 1; // 0x124(0x01)
	char UnknownData_125_0 : 7; // 0x125(0x01)
	bool bGenerateMeshSpecularMap : 1; // 0x125(0x01)
	char UnknownData_126_0 : 7; // 0x126(0x01)
	bool bGenerateLandscapeNormalMap : 1; // 0x126(0x01)
	char UnknownData_127_0 : 7; // 0x127(0x01)
	bool bGenerateLandscapeMetallicMap : 1; // 0x127(0x01)
	char UnknownData_128_0 : 7; // 0x128(0x01)
	bool bGenerateLandscapeRoughnessMap : 1; // 0x128(0x01)
	char UnknownData_129_0 : 7; // 0x129(0x01)
	bool bGenerateLandscapeSpecularMap : 1; // 0x129(0x01)
...
struct FBatchedPoint {
	...
	enum class None DepthPriority; // 0x24(0x01)
...
struct FBatchedLine {
	...
	enum class None DepthPriority; // 0x30(0x01)
	char UnknownData_31[0x3]; // 0x31(0x03)
};
...
struct FScalarParameterAtlasInstanceData {
	char UnknownData_0_0 : 7; // 0x00(0x01)
	bool bIsUsedAsAtlasPosition : 1; // 0x00(0x01)
	char UnknownData_1[0x7]; // 0x01(0x07)
...
struct FMaterialInstanceBasePropertyOverrides {
	...
	char bOverride_MaterialUsage : 1; // 0x00(0x01)
	char TwoSided : 1; // 0x00(0x01)
	char DitheredLODTransition : 1; // 0x01(0x01)
	char bCastDynamicShadowAsMasked : 1; // 0x01(0x01)
	char UnknownData_1_2 : 6; // 0x01(0x01)
	enum class EBlendMode BlendMode; // 0x02(0x01)
	enum class EMaterialShadingModel ShadingModel; // 0x03(0x01)
	struct FMaterialUsage MaterialUsage; // 0x04(0x04)
	float OpacityMaskClipValue; // 0x08(0x04)
};

// ScriptStruct Engine.MaterialUsage
// Size: 0x04 (Inherited: 0x00)
struct FMaterialUsage {
	char bUsedWithStaticMesh : 1; // 0x00(0x01)
	char bUsedWithSkeletalMesh : 1; // 0x00(0x01)
	char bUsedWithEditorCompositing : 1; // 0x00(0x01)
	char bUsedWithParticleSprites : 1; // 0x00(0x01)
	char bUsedWithBeamTrails : 1; // 0x00(0x01)
	char bUsedWithMeshParticles : 1; // 0x00(0x01)
	char bUsedWithNiagaraSprites : 1; // 0x00(0x01)
	char bUsedWithNiagaraRibbons : 1; // 0x00(0x01)
	char bUsedWithNiagaraMeshParticles : 1; // 0x01(0x01)
	char bUsedWithGeometryCache : 1; // 0x01(0x01)
	char bUsedWithStaticLighting : 1; // 0x01(0x01)
	char bUsedWithMorphTargets : 1; // 0x01(0x01)
	char bUsedWithSplineMeshes : 1; // 0x01(0x01)
	char bUsedWithInstancedStaticMeshes : 1; // 0x01(0x01)
	char bUsedWithGeometryCollections : 1; // 0x01(0x01)
	char bUsedWithClothing : 1; // 0x01(0x01)
	char bUsedWithWater : 1; // 0x02(0x01)
	char bUsedWithHairStrands : 1; // 0x02(0x01)
	char bUsedWithLidarPointCloud : 1; // 0x02(0x01)
	char UnknownData_2_3 : 5; // 0x02(0x01)
	char UnknownData_3[0x1]; // 0x03(0x01)
};
...
struct FMemberReference {
	...
	char UnknownData_30_0 : 7; // 0x30(0x01)
	bool bSelfContext : 1; // 0x30(0x01)
	char UnknownData_31_0 : 7; // 0x31(0x01)
	bool bWasDeprecated : 1; // 0x31(0x01)
...
struct FMeshInstancingSettings {
	...
	char UnknownData_D_0 : 7; // 0x0d(0x01)
	bool bSkipMeshesWithVertexColors : 1; // 0x0d(0x01)
	char UnknownData_E_0 : 7; // 0x0e(0x01)
	bool bUseHLODVolumes : 1; // 0x0e(0x01)
	char UnknownData_F[0x1]; // 0x0f(0x01)
...
struct FNavDataConfig : FNavAgentProperties {
	...
	SoftClassProperty NavDataClass; // 0x58(0x28)
	struct TArray<struct FJumpAnnotationConfig> JumpAnnotations; // 0x80(0x10)
	char UnknownData_90_0 : 7; // 0x90(0x01)
	bool bEnableCoverClimbLinks : 1; // 0x90(0x01)
	char UnknownData_91[0x7]; // 0x91(0x07)
};

// ScriptStruct Engine.JumpAnnotationConfig
// Size: 0x28 (Inherited: 0x00)
struct FJumpAnnotationConfig {
	char UnknownData_0_0 : 7; // 0x00(0x01)
	bool bEnabled : 1; // 0x00(0x01)
	char UnknownData_1[0x7]; // 0x01(0x07)
	struct UNavAreaBase* NavArea; // 0x08(0x08)
	float RunDistance; // 0x10(0x04)
	float JumpStartDist; // 0x14(0x04)
	float JumpEndDist; // 0x18(0x04)
	float GenerateFromHeight; // 0x1c(0x04)
	float GenerateToHeight; // 0x20(0x04)
	int32_t TrajectoryPow; // 0x24(0x04)
};
...
// ScriptStruct Engine.NetStatGuide
// Size: 0x10 (Inherited: 0x00)
struct FNetStatGuide {
	int32_t LessIdealPing; // 0x00(0x04)
	int32_t BadPing; // 0x04(0x04)
	int32_t LessIdealPacketLossPercentage; // 0x08(0x04)
	int32_t BadPacketLossPercentage; // 0x0c(0x04)
};
...
struct FChannelDefinition {
	...
	char UnknownData_1C_0 : 7; // 0x1c(0x01)
	bool bTickOnCreate : 1; // 0x1c(0x01)
	char UnknownData_1D_0 : 7; // 0x1d(0x01)
	bool bServerOpen : 1; // 0x1d(0x01)
	char UnknownData_1E_0 : 7; // 0x1e(0x01)
	bool bClientOpen : 1; // 0x1e(0x01)
	char UnknownData_1F_0 : 7; // 0x1f(0x01)
	bool bInitialServer : 1; // 0x1f(0x01)
	char UnknownData_20_0 : 7; // 0x20(0x01)
	bool bInitialClient : 1; // 0x20(0x01)
	char UnknownData_21[0x7]; // 0x21(0x07)
};
...
struct FGPUSpriteResourceData {
	...
	float WindInfluence; // 0x13c(0x04)
	float WindSpeedMultiplier; // 0x140(0x04)
	float RotationRateScale; // 0x144(0x04)
	float CameraMotionBlurAmount; // 0x148(0x04)
	enum class EParticleScreenAlignment ScreenAlignment; // 0x14c(0x01)
	enum class EParticleAxisLock LockAxisFlag; // 0x14d(0x01)
	char UnknownData_14E[0x2]; // 0x14e(0x02)
	struct FVector2D PivotOffset; // 0x150(0x08)
	char bRemoveHMDRoll : 1; // 0x158(0x01)
	char UnknownData_158_1 : 7; // 0x158(0x01)
	char UnknownData_159[0x3]; // 0x159(0x03)
	float MinFacingCameraBlendDistance; // 0x15c(0x04)
	float MaxFacingCameraBlendDistance; // 0x160(0x04)
...
struct FGPUSpriteEmitterInfo {
	...
	int32_t MaxParticleCountLastLOD; // 0x168(0x04)
	enum class EParticleScreenAlignment ScreenAlignment; // 0x16c(0x01)
	enum class EParticleAxisLock LockAxisFlag; // 0x16d(0x01)
	char UnknownData_16E[0x2]; // 0x16e(0x02)
	char bEnableCollision : 1; // 0x170(0x01)
	char UnknownData_170_1 : 7; // 0x170(0x01)
	char UnknownData_171[0x3]; // 0x171(0x03)
	enum class EParticleCollisionMode CollisionMode; // 0x174(0x01)
	char UnknownData_175[0x3]; // 0x175(0x03)
	char bRemoveHMDRoll : 1; // 0x178(0x01)
	char UnknownData_178_1 : 7; // 0x178(0x01)
	char UnknownData_179[0x3]; // 0x179(0x03)
	float MinFacingCameraBlendDistance; // 0x17c(0x04)
	float MaxFacingCameraBlendDistance; // 0x180(0x04)
	char UnknownData_184[0x4]; // 0x184(0x04)
	struct FRawDistributionVector DynamicColor; // 0x188(0x48)
	struct FRawDistributionFloat DynamicAlpha; // 0x1d0(0x30)
	struct FRawDistributionVector DynamicColorScale; // 0x200(0x48)
	struct FRawDistributionFloat DynamicAlphaScale; // 0x248(0x30)
...
struct FLODSoloTrack {
	struct TArray<enum class None> SoloEnableSetting; // 0x00(0x10)
};
...
// ScriptStruct Engine.HandleActionData
// Size: 0x20 (Inherited: 0x00)
struct FHandleActionData {
	char UnknownData_0[0x20]; // 0x00(0x20)
};
...
struct FPlayerMuteList {
	char UnknownData_0[0x30]; // 0x00(0x30)
	char UnknownData_30_0 : 7; // 0x30(0x01)
	bool bHasVoiceHandshakeCompleted : 1; // 0x30(0x01)
	char UnknownData_31[0x3]; // 0x31(0x03)
...
struct FRootMotionSource {
	...
	bool bInLocalSpace : 1; // 0x32(0x01)
...
struct FRootMotionSource_JumpForce : FRootMotionSource {
	...
	bool bDisableTimeout : 1; // 0xac(0x01)
...
struct FRootMotionSource_MoveToDynamicForce : FRootMotionSource {
	...
	bool bRestrictSpeedToExpected : 1; // 0xbc(0x01)
...
struct FRootMotionSource_MoveToForce : FRootMotionSource {
	...
	bool bRestrictSpeedToExpected : 1; // 0xb0(0x01)
...
struct FRootMotionSource_RadialForce : FRootMotionSource {
	...
	bool bIsPush : 1; // 0xb8(0x01)
	bool bNoZForce : 1; // 0xb9(0x01)
	...
	bool bUseFixedWorldDirection : 1; // 0xd0(0x01)
...
struct FSkeletalMaterial {
	...
	char UnknownData_8_0 : 7; // 0x08(0x01)
	bool bIsConditionallyHideable : 1; // 0x08(0x01)
	char UnknownData_9[0x3]; // 0x09(0x03)
...
struct FClothingAssetData_Legacy {
	...
	char UnknownData_18_0 : 7; // 0x18(0x01)
	bool bClothPropertiesChanged : 1; // 0x18(0x01)
	char UnknownData_19[0x3]; // 0x19(0x03)
...
struct FSkeletalMeshLODInfo {
	...
	char bHasGoreSkinning : 1; // 0xb1(0x01)
	char UnknownData_B1_5 : 3; // 0xb1(0x01)
...
struct FSkelMeshComponentLODInfo {
	...
	char UnknownData_28_0 : 7; // 0x28(0x01)
	bool bNeedsInstanceWeightUpdate : 1; // 0x28(0x01)
	char UnknownData_29_0 : 7; // 0x29(0x01)
	bool bUseAlternativeInfluences : 1; // 0x29(0x01)
	char UnknownData_2A[0x6]; // 0x2a(0x06)
};
...
struct FSkelMeshSkinWeightInfo {
	...
	enum class None Weights[0xc]; // 0x30(0x0c)
};
...
struct FSoundAttenuationSettings : FBaseAttenuationSettings {
	...
	char bIgnoreSpatializationForStereo : 1; // 0xb1(0x01)
	char UnknownData_B1_5 : 3; // 0xb1(0x01)
...
// ScriptStruct Engine.SoundPool
// Size: 0x10 (Inherited: 0x00)
struct FSoundPool {
	struct TArray<struct UAudioComponent*> SoundInstanceCollection; // 0x00(0x10)
};
...
struct FSplineInstanceData : FSceneComponentInstanceData {
	...
	bool bSplineHasBeenEdited : 1; // 0xa8(0x01)
...
struct FMeshSectionInfo {
	...
	char UnknownData_4_0 : 7; // 0x04(0x01)
	bool bEnableCollision : 1; // 0x04(0x01)
	char UnknownData_5_0 : 7; // 0x05(0x01)
	bool bCastShadow : 1; // 0x05(0x01)
	char UnknownData_6_0 : 7; // 0x06(0x01)
	bool bForceOpaque : 1; // 0x06(0x01)
	char UnknownData_7[0x1]; // 0x07(0x01)
};
...
struct FStaticMeshOptimizationSettings {
	...
	char UnknownData_10_0 : 7; // 0x10(0x01)
	bool bRecalcNormals : 1; // 0x10(0x01)
	char UnknownData_11[0x3]; // 0x11(0x03)
	float NormalsThreshold; // 0x14(0x04)
	enum class None SilhouetteImportance; // 0x18(0x01)
	enum class None TextureImportance; // 0x19(0x01)
	enum class None ShadingImportance; // 0x1a(0x01)
	char UnknownData_1B[0x1]; // 0x1b(0x01)
};
...
// ScriptStruct Engine.ShadowValidation
// Size: 0x01 (Inherited: 0x00)
struct FShadowValidation {
	char bPrimaryResult : 1; // 0x00(0x01)
	char bSecondaryResult : 1; // 0x00(0x01)
	char bPrimarySet : 1; // 0x00(0x01)
	char bSecondarySet : 1; // 0x00(0x01)
	char bCompleted : 1; // 0x00(0x01)
	char bLitByPointLight : 1; // 0x00(0x01)
	char bIsOverride : 1; // 0x00(0x01)
};

// ScriptStruct Engine.LightingScenario
// Size: 0x01 (Inherited: 0x00)
struct FLightingScenario {
	char bDefault : 1; // 0x00(0x01)
	char bPrimary : 1; // 0x00(0x01)
	char bSecondary : 1; // 0x00(0x01)
	char UnknownData_0_3 : 5; // 0x00(0x01)
};

// ScriptStruct Engine.ColorPhysicalMaterial
// Size: 0x30 (Inherited: 0x00)
struct FColorPhysicalMaterial {
	enum class EPhysicalMaterialVertexChannel ColorChannel; // 0x00(0x01)
	char UnknownData_1[0x7]; // 0x01(0x07)
	struct UPhysicalMaterial* Material; // 0x08(0x08)
	struct TArray<uint32_t> Vertices; // 0x10(0x10)
	struct TArray<uint32_t> Triangles; // 0x20(0x10)
};
...
struct FStaticParameterSet {
	...
	struct TArray<struct FStaticMultiSwitchParameter> StaticMultiSwitchParameters; // 0x10(0x10)
	struct TArray<struct FStaticComponentMaskParameter> StaticComponentMaskParameters; // 0x20(0x10)
	struct TArray<struct FStaticTerrainLayerWeightParameter> TerrainLayerWeightParameters; // 0x30(0x10)
	struct TArray<struct FStaticMaterialLayersParameter> MaterialLayersParameters; // 0x40(0x10)
};
...
struct FStaticTerrainLayerWeightParameter : FStaticParameterBase {
	...
	char UnknownData_28_0 : 7; // 0x28(0x01)
	bool bWeightBasedBlend : 1; // 0x28(0x01)
	char UnknownData_29[0x3]; // 0x29(0x03)
};
...
// ScriptStruct Engine.StaticMultiSwitchParameter
// Size: 0x38 (Inherited: 0x24)
struct FStaticMultiSwitchParameter : FStaticParameterBase {
	char UnknownData_24[0x4]; // 0x24(0x04)
...
struct FSubsurfaceProfileStruct {
	...
	char UnknownData_28_0 : 7; // 0x28(0x01)
	bool bEnableBurley : 1; // 0x28(0x01)
	char UnknownData_29[0x3]; // 0x29(0x03)
...
struct FTextureLODGroup {
	...
	bool DuplicateNonOptionalMips : 1; // 0x51(0x01)
...
struct FTimelineEventEntry {
	float Time; // 0x00(0x04)
	char UnknownData_4[0x4]; // 0x04(0x04)
	struct FDelegate EventFunc; // 0x08(0x10)
};
...
struct FTTTrackBase {
	...
	char UnknownData_10_0 : 7; // 0x10(0x01)
	bool bIsExternalCurve : 1; // 0x10(0x01)
	char UnknownData_11[0x7]; // 0x11(0x07)
};
...
struct FTimeStretchCurveInstance {
	char UnknownData_0_0 : 7; // 0x00(0x01)
	bool bHasValidData : 1; // 0x00(0x01)
...
struct FVirtualTextureBuildSettings {
	...
	char UnknownData_8_0 : 7; // 0x08(0x01)
	bool bEnableCompressCrunch : 1; // 0x08(0x01)
	char UnknownData_9_0 : 7; // 0x09(0x01)
	bool bEnableCompressZlib : 1; // 0x09(0x01)
	char UnknownData_A[0x2]; // 0x0a(0x02)
};
...
struct FVirtualTextureSpacePoolConfig {
	...
	char UnknownData_1C_0 : 7; // 0x1c(0x01)
	bool bAllowSizeScale : 1; // 0x1c(0x01)
	char UnknownData_1D[0x3]; // 0x1d(0x03)
};
...
struct FPSCPool {
	...
	struct TArray<struct UParticleSystemComponent*> InUseComponents_ManualOnComplete; // 0x30(0x10)
	char UnknownData_40[0x8]; // 0x40(0x08)
};
...
struct FBroadphaseSettings {
	char UnknownData_0_0 : 7; // 0x00(0x01)
	bool bUseMBPOnClient : 1; // 0x00(0x01)
	char UnknownData_1_0 : 7; // 0x01(0x01)
	bool bUseMBPOnServer : 1; // 0x01(0x01)
	char UnknownData_2_0 : 7; // 0x02(0x01)
	bool bUseMBPOuterBounds : 1; // 0x02(0x01)
	char UnknownData_3[0x1]; // 0x03(0x01)
